...
module.exports = function (bot) {
    return function (message, args) {
        ...
        let category = !_.isNull(args[args.length - 1]) && args[args.length - 1].substr(0, 1) == '#' ? args[args.length - 1] : null
        let description = category ? _.join(_.slice(args, 1, args.length - 1), ' ') : _.join(_.slice(args, 1), ' ')
